    ...
    extend: {
      ...
      colors: {
        ...
        landing: {
          ...
          "surface-alt": "hsl(var(--landing-surface-alt))",
        },
        btn: {
          primary: {
          ...
          outline: {
            border: "hsl(var(--btn-outline-border))",
            hover: "hsl(var(--btn-outline-hover))",
            "hover-border": "hsl(var(--btn-outline-hover-border))",
          },
          destructive: {
            DEFAULT: "hsl(var(--btn-destructive))",
            foreground: "hsl(var(--btn-destructive-foreground))",
            hover: "hsl(var(--btn-destructive-hover))",
          },
          ghost: {
            hover: "hsl(var(--btn-ghost-hover))",
          },
          success: {
          ...
          warning: {
            DEFAULT: "hsl(var(--btn-warning))",
            foreground: "hsl(var(--btn-warning-foreground))",
            hover: "hsl(var(--btn-warning-hover))",
          },
        },
      },
      borderRadius: {
